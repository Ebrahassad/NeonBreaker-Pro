...
class AdService {
  ...
  /// Call this at natural break points (returning home, finishing a level,
  /// retrying after a loss). Only actually shows an ad every few calls so
  /// play never feels interrupted too often.
  ...
  /// Shows a rewarded ad; [onReward] only fires once the video is watched
  /// to completion. If no ad is available, nothing happens and the caller
  /// can decide how to react (e.g. keep the button disabled).
