    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          ...
          BoxShadow(
            color: NeonColors.pink.withValues(alpha: .12),
            blurRadius: 55,
            spreadRadius: 4,
          ),
        ],
  ...
  Widget _buildBestScore() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: NeonColors.cyan.withValues(alpha: .18),
        ),
        boxShadow: [
          BoxShadow(
    ...
    return SizedBox(
      ...
      child: OutlinedButton.icon(
        ...
        style: OutlinedButton.styleFrom(
          foregroundColor: Colors.white,
          side: BorderSide(
            color: NeonColors.cyan.withValues(alpha: .40),
          ),
...
class _NeonBackground extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: _NeonBackgroundPainter(),
      size: Size.infinite,
    );
  }
}
