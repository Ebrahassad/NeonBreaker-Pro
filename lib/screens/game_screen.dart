    ...
    bool shouldSpawnBrick(int row, int col) {
      ...
      switch (pattern) {
        ...
        case StagePattern.diamond:
          return row >= distance - .5 && row <= 7 - distance + .5;
        ...
        case StagePattern.pyramid:
          ...
          return col >= left && col < left + width;
        ...
        case StagePattern.tunnel:
          return row < 2 || row >= rows - 2 || col == 0 || col == columns - 1;
